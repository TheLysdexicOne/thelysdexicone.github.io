...
console.log('\nNext steps:');
console.log('1. Review the dist/ folder locally');
console.log('2. Commit and push to GitHub:');
console.log('   git add -A');
console.log('   git commit -m "Deploy: build all projects"');
console.log('   git push origin main');
console.log('\nGitHub Pages will serve from:');
console.log('  https://thelysdexicone.github.io/ (landing page)');
console.log('  https://thelysdexicone.github.io/ball-x-pit-companion/ (companion)');
