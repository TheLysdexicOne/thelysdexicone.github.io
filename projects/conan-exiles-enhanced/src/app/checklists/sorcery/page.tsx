export default function SorceryChecklistPage() {
  return (
      ...
      <div className="app-container max-w-5xl">
        <section className="rounded-lg border-2 border-primary bg-card p-6 sm:p-8">
          ...
          <p className="mt-4 max-w-3xl text-sm leading-relaxed text-secondary sm:text-base">
            Sorcery starts with the Journey system, but its real progression
            continues through the Thaumaturgy Bench. This checklist will later
            tie bench recipes and related costs into the existing crafting
            multiplier setting.
          </p>
        </section>
      </div>
